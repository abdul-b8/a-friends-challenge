...
function setup() {
  ...
  //backg = createSprite(400,200,20,20);
...
function draw() {
  ...
  if (score < 1000){
    ...
    textSize(20);
    fill("white");
    text("Getting to 1000 is very hard. Can you do it?",20,20);
    }
  ...
  if (score < 2000 && score > 1000){
    ...
    textSize(20);
    fill("white");
    text("Only experts get to 2000...",20,20);
  ...
  if (score < 3000 && score > 2000 ){
    ...
    textSize(20);
    fill("white");
    text("The difference between good & great is 3000",20,20);
  ...
  if (score < 4000 && score > 3000){
    ...
    textSize(20);
    fill("white");
    text("3000 is respectable. 4000 is impressive",20,20);
  ...
  if (score < 5000 && score > 4000){
    ...
    textSize(20);
    fill("white");
    text("The ultimate test is 5000. Good luck.",20,20);
  ...
  if (score > 5000){
    ...
    textSize(20);
    fill("white");
    text("You are a true professional. keep going!",20,20);
  ...
  if (obsGroup.isTouching(player)){
      ...
      speedupGroup.setVelocityXEach(0);
     ...
     if (gameState === 0 && score < 5000){
      ...
      textSize(20);
      fill("white");
      text("Maybe this isnt for you, but Thomas Edison took forever to make the lightbulb, right?",20,50);
                  }          
